...
def test_server_web_build_publishes_zip_guide_and_excludes_legacy_helper():
    ...
    assert "JinshiDSH-Workbench-1.0.37.zip" in script
    assert "JinshiDSH-Workbench-1.0.37.sha256.txt" in script
    ...
    assert "downloads/JinshiDSH-Workbench-1.0.37.zip" in web
