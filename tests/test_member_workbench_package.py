...
def test_server_web_build_publishes_zip_guide_and_excludes_legacy_helper():
    ...
    assert "JinshiDSH-Workbench-1.0.41.zip" in script
    assert "JinshiDSH-Workbench-1.0.41.sha256.txt" in script
    ...
    assert "downloads/JinshiDSH-Workbench-1.0.41.zip" in web
