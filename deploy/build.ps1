...
foreach ($name in "JinshiDSH-Workbench-1.0.29.zip", "JinshiDSH-Workbench-1.0.29.sha256.txt") {
...
$zipHash = (Get-FileHash -LiteralPath (Join-Path $downloads "JinshiDSH-Workbench-1.0.29.zip") -Algorithm SHA256).Hash
$latest = [ordered]@{
    schema_version = "member-workbench-update-v1"
    version = "1.0.29"
    zip_url = "http://114.132.236.131/dsh/downloads/JinshiDSH-Workbench-1.0.29.zip"
    sha256_url = "http://114.132.236.131/dsh/downloads/JinshiDSH-Workbench-1.0.29.sha256.txt"
    sha256 = $zipHash
